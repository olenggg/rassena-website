...
<div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Rassena</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="/products" class="py-2 d-block">Produk</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Perumahan Rewwin, Jl. Taman Cendrawasih No.5, Ngeni, Kepuhkiriman, Kec. Waru, Kabupaten Sidoarjo, Jawa Timur 61256</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+62 318 670 584</span></a></li>
    ...
    <!-- <div class="copyright text-center my-auto">
      <span>This website is made with Love by Rassena</span>
      <p>Copyright © Rassena 2019</p>
</div> -->
</footer>
